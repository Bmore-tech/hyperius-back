...
public class ConfirmaPickingHuUbicacionRequest {
	...
	public String getOrdProd() {
		return ordProd;
	}

	public void setOrdProd(String ordProd) {
	...
	public String getOrigen0() {
		return origen0;
	}

	public void setOrigen0(String origen0) {
