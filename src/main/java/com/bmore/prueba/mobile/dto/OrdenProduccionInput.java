...
public class OrdenProduccionInput {
	...
	public String toString() {
		return "OrdenProduccionInput [cant=" + cant + ", cantT=" + cantT + ", checkBestq=" + checkBestq
				+ ", confUbicacionDestino=" + confUbicacionDestino + ", hu1=" + hu1 + ", hu2=" + hu2 + ", lgort="
				+ lgort + ", maktx=" + maktx + ", materiales=" + materiales + ", matnr=" + matnr + ", matnrT=" + matnrT
				+ ", numeroHus=" + numeroHus + ", ordeProduccion=" + ordeProduccion + ", resultDT=" + resultDT
				+ ", tarima=" + tarima + ", uDestino0=" + uDestino0 + ", uDestino1=" + uDestino1 + ", uDestino2="
				+ uDestino2 + ", uOrigen0=" + uOrigen0 + ", uOrigen1=" + uOrigen1 + ", uOrigen2=" + uOrigen2
				+ ", usuarioMontacarga=" + usuarioMontacarga + ", werks=" + werks + "]";
	}
