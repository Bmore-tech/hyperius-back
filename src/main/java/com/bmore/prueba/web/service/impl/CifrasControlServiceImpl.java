...
public class CifrasControlServiceImpl implements CifrasControlService {
	...
	public DescargaInformacionDTO getDescargaInformacion() {
		...
		// CifrasControlRepositoryOld cifrasControlDAO = new CifrasControlRepositoryOld();
	...
	public File generateReports(DescargaInformacionDTO descargaInformacionDTO) {
		...
		if (reportDate.size() > 0) {
			...
			try {
				...
				LOCATION.error("CifrasControlBO - generateReports - UnsupportedEncodingException: " + e.getMessage());
				generateReports = null;
			} catch (FileNotFoundException e) {
				LOCATION.error("CifrasControlBO - generateReports - FileNotFoundException: " + e.getMessage());
				generateReports = null;
			}
		}
