...
public class EmbarqueDetalleDTO {
	...
	public String toString() {
		return "EmbarqueDetalleDTO [cajas=" + cajas + ", cajasAsignadas="
				+ cajasAsignadas + ", descripcion=" + descripcion + ", hus="
				+ hus + ", husAsignadas=" + husAsignadas + ", lote=" + lote
				+ ", material=" + material + ", me=" + me + ", posicion="
				+ posicion + ", vbeln=" + vbeln + "]";
	}
