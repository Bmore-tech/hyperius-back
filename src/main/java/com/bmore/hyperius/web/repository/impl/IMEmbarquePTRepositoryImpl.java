...
import com.bmore.hyperius.web.repository.IMEmbarquePTRepository;
...
public class IMEmbarquePTRepositoryImpl implements IMEmbarquePTRepository {
  ...
  public EntregaDetalleDTO getDataHU(String hu, String werks, String lgtyp, String lgpla) {
    ...
    int respuesta = jdbcTemplate.queryForObject(query1, new RowMapper<Integer>() {
    ...
    if (respuesta == 1) {
      ...
      entrega = jdbcTemplate.queryForObject(query2, new RowMapper<EntregaDetalleDTO>() {
  ...
  public EmbarqueDTO getEmbarque(EmbarqueDTO embarqueDTOInput) {
    ...
    embarqueDTO = jdbcTemplate.queryForObject(query1, new RowMapper<EmbarqueDTO>() {
      ...
      public EmbarqueDTO mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        return jdbcTemplate.queryForObject(query2, new RowMapper<EmbarqueDTO>() {
        ...
        jdbcTemplate.query(query2, new RowMapper<Integer>() {
          ...
          public Integer mapRow(ResultSet rs, int rowNum) throws SQLException {
            if (map.get(rs.getString("MATNR")) == null) {
              ...
              jdbcTemplate.queryForObject(query4, new RowMapper<Integer>() {
  ...
  public CarrilesUbicacionDTO getStock(String werks, String matnr) {
    ...
    carrilList = jdbcTemplate.query(query1, new RowMapper<CarrilUbicacionDTO>() {
