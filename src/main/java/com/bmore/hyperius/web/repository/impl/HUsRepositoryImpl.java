...
public class HUsRepositoryImpl implements HUsRepository {
  ...
  public ResultDTO obtieneHuExterna(String hu) {
    ...
    jdbcTemplate.query(query, args, new RowMapper<Integer>() {
  ...
  public HusDTO obtieneHusBCPS(HuDTO huDTO) {
    ...
    List<HuDTO> itemList = jdbcTemplate.query(OBTENER_STATUS_HUS_BCPS, args, new RowMapper<HuDTO>() {
  ...
  public HusDTO obtieneHusCarrilPorMaterial(HuDTO huDTO) {
    ...
    List<HuDTO> itemList = jdbcTemplate.query(query, args, new RowMapper<HuDTO>() {
  ...
  public HusDTO validarHU(String hu, String werks) {
    ...
    HuDTO huDTO = jdbcTemplate.queryForObject(VALIDAR_HU_LQUA, args, new RowMapper<HuDTO>() {
  ...
  public HusDTO validarHUVidrio(String exidv, String werks) {
    ...
    HuDTO huDTO = jdbcTemplate.queryForObject(VALIDAR_HU_VKP, args, new RowMapper<HuDTO>() {
